...
CREATE TABLE `content_queue` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7844 DEFAULT CHARSET=utf8mb4;
...
(7841,'tv',583401,'Texas Cop Shot To Death Chasing Mexican Citizen Along the U.S. Border','https://mrctv.org/node/583401','Brittany M. Hughes',1697742485,0,'ftv|ttv',1),
(7842,'cns',583402,'‘Repeating Hamas’ Lies Can - and Does - Cost Lives in Gaza, Israel and Around the World,’ IDF Warns','https://mrctv.org/node/583402','Craig Bannister',1697743379,2,'fcns|tcns',1),
(7843,'free speech',281112,'Enough! GOP Attorneys General’s Scorching Warning to Anti-Free Speech Eventbrite','https://newsbusters.org/node/281112','Luis Cornelio',1697742742,0,'',1);
...
-- Dump completed on 2023-10-19 19:50:31
