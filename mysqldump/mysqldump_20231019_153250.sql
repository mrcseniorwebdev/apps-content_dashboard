...
CREATE TABLE `content_queue` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7843 DEFAULT CHARSET=utf8mb4;
...
(7842,'cns',583402,'‘Repeating Hamas’ Lies Can - and Does - Cost Lives in Gaza, Israel and Around the World,’ IDF Warns','https://mrctv.org/node/583402','Craig Bannister',1697743379,2,'',1);
...
-- Dump completed on 2023-10-19 19:32:50
